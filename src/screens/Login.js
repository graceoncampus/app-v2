...
import { FormGroup, Spinner } from '@shoutem/ui';
  ...
  renderButton = () => {
    ...
    return (
      <Button style={{ marginVertical: 10 }} onPress={this.onButtonPress}>
        <Text size="buttonText" >LOG IN</Text>
      </Button>
    );
  }
      ...
      <View style={styles.screen}>
        <KeyboardAwareScrollView>
          <View style={styles.tile}>
            ...
            <Text size="title">GRACE ON CAMPUS</Text>
            <Text size="subtitle" style={{ textAlign: 'center', color: '#b40a34', paddingVertical: 10 }} >{error}</Text>
          </View>
          <FormGroup style={{ paddingHorizontal: 25, flex: 0.56 }}>
            <Text size="label">Email</Text>
            <TextInput
              underlineColorAndroid='transparent'
              style={[styles.input, focus === 'one' && styles.focused]}
              ...
              returnKeyType='next'
            />
            <Text size="label">Password</Text>
            <TextInput
              underlineColorAndroid='transparent'
              style={[styles.input, focus === 'two' && styles.focused]}
            ...
            <TouchableOpacity style={{ paddingBottom: 10 }} onPress={() => this.props.navigation.navigate('Forgotpassword')}>
              <View><Text size="caption" style={{ color: '#ae956b', textAlign: 'center' }}>Forgot password?</Text></View>
            </TouchableOpacity>
            <Divider type="line" />
          </FormGroup>
          <View style={{ paddingHorizontal: 25, flex: 0.14 }} styleName='vertical h-center v-end'>
            <Button clear style={{ marginBottom: 10 }} onPress={() => this.props.navigation.navigate('Signup')}>
              <Text size="buttonTextGold">SIGN UP</Text>
            </Button>
            <Divider />
          </View>
        </KeyboardAwareScrollView>
